...
public class EmpleadoController {
	...
	public String nuevoEmpleadoSubmit(@Valid @ModelAttribute("empleado") Empleado nuevoEmpleado,//setea el empleado 
			BindingResult bindingResult) {
		if (bindingResult.hasErrors()) {//comprueba las validaciones que tenemos dentro de la clase por anotaciones
			return "form";
		} else {
